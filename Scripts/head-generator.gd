...
var eye_choice = 8
var mouth_choice = 4
#TODO: i think this should be replaced by a selection of prechosen colours. 
#aligns it with eyes/mouth selection
#	   and ensures characters features are readable 
